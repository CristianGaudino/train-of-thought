...
export default function GlobalError({
    ...
    return (
        <div className="min-h-screen bg-zinc-50 flex flex-col items-center justify-center px-6 text-center">
            ...
            {error.digest && (
                <p className="text-[11px] text-zinc-300 font-primary mb-6 font-mono">
            ...
            <div className="flex items-center gap-3">
                <button
                    onClick={reset}
                    className="px-5 py-2.5 rounded-xl bg-zinc-900 text-white text-[13px] font-semibold font-primary hover:bg-zinc-700 transition-colors cursor-pointer"
                >
                    Try again
                </button>
                <Link
