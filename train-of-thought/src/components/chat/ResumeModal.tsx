                ...
                {step === "resume" ? (
                    <>
                        ...
                        <div className="relative px-5 pt-4 pb-2">
                            <p className="text-xs text-zinc-400 mb-3">You have an unfinished conversation.</p>
                                        ...
                                        return (
                                            <div key={i} className={`flex ${isUser ? "justify-end" : "justify-start"}`}>
                                                <div className={`px-3 py-2 rounded-xl text-xs max-w-[85%] leading-relaxed ${
                                                    isUser ? "bg-zinc-900 text-white" : "bg-white border border-zinc-200 text-zinc-700"
                                                }`}>
                                                    {text}
                                                </div>
                                            </div>
                        ...
                        <div className="px-5 py-4 flex items-center justify-between gap-2">
                            <button
                                onClick={() => showConceptsStep ? setStep("concepts") : onStartFresh(false)}
                    ...
                    <>
                        <div className="flex items-center gap-2 px-5 py-4 border-b border-zinc-100">
                            <MessageCircle size={15} className="text-zinc-400" />
                            <span className="text-sm font-semibold text-zinc-800">Your concepts</span>
                        </div>
